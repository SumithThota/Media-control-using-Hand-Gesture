...
# from models.model_architecture import model
# from utils import *  # Assuming you have custom utility functions defined
...
# IS_ABSENT = None  # For testing purposes; change this by video status (paused or playing)
# ABSENCE_COUNTER = 0
# ABSENCE_COUNTER_THRESH = 20

# # Frontal face + face landmarks (sleepiness feature)
# SHAPE_PREDICTOR_PATH = "models/shape_predictor_68_face_landmarks.dat"
# detector = dlib.get_frontal_face_detector()
# predictor = dlib.shape_predictor(SHAPE_PREDICTOR_PATH)
# lStart, lEnd = face_utils.FACIAL_LANDMARKS_IDXS["left_eye"]
...
# IS_SLEEPING = None  # For testing purposes; change this by video status (paused or playing)
# SLEEP_COUNTER = 0
# SLEEP_COUNTER_THRESH = 20
# EAR_THRESH = 0.21
# EAR_HISTORY = deque([])
...
#     # Ensure the frame is not empty before detection
...
#             if mean_ear < EAR_THRESH:
#                 SLEEP_COUNTER += 1
#                 if SLEEP_COUNTER > SLEEP_COUNTER_THRESH and IS_SLEEPING is False:
#                     pyautogui.press('space')
#                     IS_SLEEPING = True
#             else:
#                 SLEEP_COUNTER = 0
...
#     # Based on MediaPipe face detection (more robust)
#     results = face_detection.process(frame_rgb)

#     # Check if no face is detected; if so, pause the video
#     if results.detections is None:
#         ABSENCE_COUNTER += 1
#         if ABSENCE_COUNTER > ABSENCE_COUNTER_THRESH and IS_ABSENT is False:
#             pyautogui.press('space')
#             IS_ABSENT = True
#     else:
#         ABSENCE_COUNTER = 0
